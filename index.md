...
LeanChess is a [free][license] chess program for the IBM PC AT and compatibles. As of this writing, it’s the world’s [smallest](#smallest) [chess-playing](#chess) program. Its smallest [edition] takes up 293 bytes, 59 bytes fewer than the [previous record holder][ChesSkelet] and 43 bytes **fewer than half the size** of the legendary [1K ZX Chess][1kchess]!

How little is 293 bytes? Following Alex Garcia's (lost) lead, we've been tweaking the text in the previous paragraph so that it occupies the same exact amount of RAM (sans links and formatting).

> As the program shrinks it's becoming a challenge to adjust the paragraph. :-)

**Update 09/12/2019:** [Version 1.9.2][releases] removes a further 4 bytes in Barebone editions!
...
&nbsp;   | DOS | BIOS
---------|-----|-----
Barebone |![LCBD](images/lcbd.png) [COM (293b)](https://github.com/leanchess/leanchess/releases/download/v1.9.2/LCBD.COM)  [ASM](https://github.com/leanchess/leanchess/raw/master/LC.ASM)|![LCBB](images/lcbb.png) [COM (298b)](https://github.com/leanchess/leanchess/releases/download/v1.9.2/LCBB.COM)  [ASM](https://github.com/leanchess/leanchess/raw/bios/LC.ASM)
Classic  |![LCCD](images/lccd.png) [COM (307b)](https://github.com/leanchess/leanchess/releases/download/v1.9.2/LCCD.COM) [ASM](https://github.com/leanchess/leanchess/raw/classic/LC.ASM) |![LCCB](images/lccb.png) [COM (312b)](https://github.com/leanchess/leanchess/releases/download/v1.9.2/LCCB.COM)  [ASM](https://github.com/leanchess/leanchess/raw/classic-bios/LC.ASM)
