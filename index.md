...
How little is 302 bytes? Following Alex Garcia's (lost) lead, we've been tweaking the text in the previous paragraph so that it takes up the same exact amount of RAM (sans links).
